...
//				$configValues['CONFIG_DB_TBL_DALODICTIONARY']." WHERE Vendor='WISPr' OR Vendor='dictionary.rfc2865' ORDER BY Vendor ASC";
...
-->
                <script type="text/javascript">                    
                    getAttributesList('WISPr','dictAttributesDatabase');
...
-->
		...
		<input type='hidden' id='dictAttributesCustom' style='width: 264px' />
		<br/>
